...
try:
    ...
    print(f"   Throughput: {rust_stats.get('files_indexed', 1) / rust_indexing_time:.1f} files/s")
...
try:
    ...
    print("-" * 75)
    print(f"{'Files indexed':<30} {python_stats['files_indexed']:>15} {rust_files:>15} {'-':>15}")
    print(f"{'Chunks created':<30} {python_chunk_count:>15} {rust_chunks:>15} {'-':>15}")
    print(f"{'Indexing time (s)':<30} {python_indexing_time:>15.3f} {rust_time:>15.3f} {speedup:>14.1f}x")
    print(f"{'Files/second':<30} {python_stats['files_indexed']/python_indexing_time:>15.1f} {rust_files/rust_time:>15.1f} {speedup:>14.1f}x")
